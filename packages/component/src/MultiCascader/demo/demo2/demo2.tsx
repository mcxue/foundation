    ...
    return (
        <>
            ...
            <div className="box">
                ...
                <BlMultiCascader data={multiCascaderOptions} style={{ width: 300 }}
                    value={value3}
                    onChange={(value) => { console.log(`value3`, value); setValue3(value) }}
                    renderValue={(value, selectedItems, selectedElement) => (
                        <span>
                            {selectedItems.map(item => item.label).join(' 、')}
                        </span>
            ...
            <div className="box">
                ...
                <BlMultiCascader data={multiCascaderOptions} style={{ width: 300 }}
                    value={value4}
                    onChange={(value) => { console.log(`value4`, value); setValue4(value) }}
                    placeholder={
                        <span>
            ...
            <div className="box">
                ...
                <BlMultiCascader data={multiCascaderOptions} style={{ width: 300 }}
                    value={value5}
                    onChange={(value) => { console.log(`value5`, value); setValue5(value) }}
